/**
 * Devnet Program Verification Script
 *
 * Verifies that all 5 Hypernode programs are deployed and accessible on devnet.
 * Run: ts-node tests/devnet-verify.ts
 */

import { Connection, PublicKey } from "@solana/web3.js";
import { DEVNET_CONFIG } from "../sdk/src/config";
...
async function main() {
  ...
  console.log("\n📝 Next Steps:");
  console.log("1. Run: ts-node sdk/examples/devnet-quickstart.ts");
  console.log("2. Create test transactions to verify program instructions");
  console.log("3. Test cross-program invocations (CPI)");
  console.log("\nExplorer Links:");
  programs.forEach(p => {
